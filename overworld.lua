function overworld_new()
  ...
  function me:update()
    ...
    elseif state.enter then
      ...
      local bat_fought = bat and global.battle_locations_fought[coord_key]
  ...
  function me:draw()
    local coord_key = global.coord.tx .. "," .. global.coord.ty
    local player_x = global.coord.tx * 8
    local player_y = global.coord.ty * 8 - 4
    local player_flip_x = global.coord.dx > 0
